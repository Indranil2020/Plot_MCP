...
- `plot_data`:
  ...
  - Returns: text block (code + warnings + saved image path + latest viewer) and PNG image block
- `describe_file`:
...
- `PLOT_MCP_ALLOWED_DIRS`: colon-separated allowed roots for file tools (default repo root)
